...
- (id)initWithTitle:(NSString *)title delegate:(id /*<UIActionSheetDelegate>*/)delegate
{
    ...
    if (self) {
        ...
        self.locate.city_id = [[cities objectAtIndex:0] objectForKey:@"city_id"] ;
        self.locate.province_id = [[cities objectAtIndex:0] objectForKey:@"province_id"];
    }
    return self;
}
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    switch (component) {
        ...
        case 1:
            ...
            self.locate.city_id = [[cities objectAtIndex:row] objectForKey:@"city_id"] ;
            self.locate.province_id = [[cities objectAtIndex:row] objectForKey:@"province_id"] ;
            break;
        default:
            break;
    }
