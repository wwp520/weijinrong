...
#pragma mark - 实现
@implementation LoanFinController
...
- (LoanFinCollection *)collection {
    if (!_collection) {
        _collection = [LoanFinCollection loadCode:CGRectMake(0, CGRectGetMaxY(_table.frame), ScreenWidth, ScreenWidth + 50)];
        _collection.moneyCount = 9;
